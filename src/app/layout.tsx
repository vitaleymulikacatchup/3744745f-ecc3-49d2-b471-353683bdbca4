...
export const metadata: Metadata = {
  title: "Jovalunga - Fine Dining Restaurant",
  description: "Experience culinary excellence at Jovalunga. Award-winning restaurant offering seasonal menus, wine pairings, and unforgettable dining experiences.",
  keywords: "fine dining restaurant, gourmet cuisine, reservations, seasonal menu, chef",
  metadataBase: new URL("https://jovalunga.com"),
  alternates: {
    canonical: "https://jovalunga.com"
  },
  robots: {
    index: true,
    follow: true
  ...
  openGraph: {
    title: "Jovalunga - Fine Dining Restaurant",
    description: "Experience culinary excellence at Jovalunga",
    type: "website",
    siteName: "Jovalunga",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1766051943567-tzvyzois.jpg",
      alt: "Jovalunga signature dish"
    }]
  },
  twitter: {
    ...
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1766051943567-tzvyzois.jpg"]
  }
};
